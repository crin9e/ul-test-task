...
export function getAuctionTypeLabel(value: AuctionType | string | null | undefined): string {
  return getRuntimeLabel(auctionTypeLabels, value, 'Неизвестный тип');
}

export function getAuctionStatusLabel(value: AuctionStatus | string | null | undefined): string {
  return getRuntimeLabel(auctionStatusLabels, value, 'Неизвестный статус');
}

export function getTradingStatusLabel(value: TradingStatus | string | null | undefined): string {
  return getRuntimeLabel(tradingStatusLabels, value, 'Неизвестный статус участия');
}
...
export function getPaymentDelayLabel(value: PaymentDelayType | string | undefined): string {
