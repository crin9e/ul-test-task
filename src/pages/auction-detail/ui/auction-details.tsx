  ...
  return (
    <>
      ...
      {auction.historyHidden && (
        <p className={styles.notice}>История ставок скрыта организатором.</p>
      )}
      ...
      <div className={styles.sectionGrid}>
        ...
        <article>
          ...
          {auction.addressesAndContactsHidden ? (
            <p className={styles.notice}>Контакты скрыты организатором.</p>
          ...
          {auction.routes.map((route) => (
            <li key={`${route.rowNumber}-${route.operation}`}>
              <section className={styles.routePoint}>
                ...
                />
                {route.address && <p>Адрес: {route.address}</p>}
                {route.contractor && (
                  <p>
